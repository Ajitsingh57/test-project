...
import { bookingStyles,statusBadgeStyles,paymentBadgeBaseStyles,badgeBaseStyles,paymentBadgeStyles } from '../assets/dummyStyles'
    ...
    <div className={bookingStyles.root}>
      <div className={bookingStyles.container}>
        <div className={bookingStyles.headerContainer}>
          ...
          <div>
            <h1 className={bookingStyles.headerTitle}>
              Manage Booking
            </h1>
            <p className={bookingStyles.headerSubtitle}>
            Veiw and Manage customer booking
            </p>
          </div>
        </div>
          ...
          <div className={bookingStyles.filterContainer}>
            ...
            <div className='flex flex-col sm:flex-row gap-3 w-full md:w-auto'>
              <div className={bookingStyles.searchContainer}>
                ...
                <input value={searchTerm} onChange={(e)=>setSearchTerm(e.target.value)} className={bookingStyles.searchInput} placeholder='Search bookings...' />
              </div>
        ...
        {loading && (
          <div className={bookingStyles.loadingText}>Loading Booking... </div>
        )}
        {error &&(
