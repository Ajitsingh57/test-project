      ...
      <div className={footerStyles.mainContainer}>
        <div className={footerStyles.newsletterSection}>
            <div className={footerStyles.newsletterContent}>
                <h3 className={footerStyles.newsletterText}>
                    Timeless Elegannce, Delivered
                </h3>
                <p className={footerStyles.newsletterText}>
                Subscribe to our newsletter for exclusive offer , new collection announcement and styling tips.
                </p>
        ...
        <div className={footerStyles.mainGrid}>
            ...
            <div className={footerStyles.brandIconContainer}>
                <div className={footerStyles.brandIconPing}>
                </div>
                    <Clock className={footerStyles.brandIcon}/>                    
            </div>
                <span className={footerStyles.brandName}>Chrone Styles</span>
            </div>
            <p className={footerStyles.brandDescription}>
                Crafting timeless piecess for the discerning individual. Where precision meets elegance in every detail
            </p>
            <div className={footerStyles.socialIconsContainer}>
                {[BsFacebook,BsTwitterX,BsInstagram].map((Icon, index) => (
        ...
        <div className={footerStyles.bottomSection}>
              <p className={footerStyles.copyright}>
                &copy;{new Date().getFullYear()} ChroneStyles. Crafted with {"  "}
                <Heart className={footerStyles.heartIcon}/> In India
              </p>
              <div className="flex flex-wrap justify-center gap-2">
                <p className={footerStyles.designerLink}>
                Designed by {"  "}
                <a href="https://www.linkedin.com/in/ajit-kumar-79b3b9402/" target='_blank' rel='noopener noreferrer' className={footerStyles.linkHover}>Ajit Singh</a>
                </p>
              </div>
        </div>
      </div>
