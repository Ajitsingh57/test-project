...
export default function WatchPage() {
    ...
    const [loading , setLoading]=useState(true);
     ...
     //to normalize server item coming from server
      ...
      <ToastContainer/>
        <div className={watchPageStyles.headerContainer}>
            ...
            {FILTERS.map((f)=>{
                ...
                return(
                    <button key={f.key} onClick={()=>setFilter(f.key)} className={`${watchPageStyles.filterButtonBase} ${active?watchPageStyles.filterButtonActive:watchPageStyles.filterButtonInactive}`}>
