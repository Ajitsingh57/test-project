...
import { brandPageStyles, watchPageStyles } from '../assets/dummyStyles'
...
export default function BrandPage() {
   ...
   const [error,setError]=useState(null);
    ...
    //to fetch brand watches using brandId
     ...
     <div className="max-w-7xl mx-auto relative ">
        ...
        <div className={brandPageStyles.grid}>
          {brandWatches.map((watch)=>{
            ...
            const displayedQty=inCart?.qty??inCart?.quantity ?? inCart?.count??0;
                    ...
                    <div className={brandPageStyles.priceAndControls}>
                        ...
                        {displayedQty>0 ? (
                          <div className={brandPageStyles.quantityContainer}>
                              <button onClick={()=>decrement(targetId)} className={brandPageStyles.quantityButton}>
                              <Minus className={watchPageStyles.quantityIcon}/>
                              </button>
                              <div className={brandPageStyles.quantityCount}>
                                  {displayedQty}
                              </div>
                              <button onClick={()=>increment(targetId)} className={brandPageStyles.quantityButton}>
