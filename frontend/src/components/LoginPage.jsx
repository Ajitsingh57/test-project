        ...
        <div className={loginPageStyles.loginCard}>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className={loginPageStyles.inputContainer}>
                  <div className={loginPageStyles.inputIconContainer}>
                    ...
                    <input type="email" id='email' className={loginPageStyles.inputBase} placeholder='Enter your email' value={email} onChange={(e)=>setEmail(e.target.value)} required disabled={submitting} />
              </div>
              </div>
              <div className={loginPageStyles.formField}>
              ...
              <div className={loginPageStyles.inputContainer}>
                  <div className={loginPageStyles.inputIconContainer}>
                    ...
                    <input type={showPassword?"text":"password"} id='password' className={loginPageStyles.inputBase} placeholder='Enter your password' value={password} onChange={(e)=>setPassword(e.target.value)} required disabled={submitting} />
              ...
              <div className={loginPageStyles.rememberMeContainer}>
                  <div className={loginPageStyles.checkboxContainer}>
                        <input type="checkbox" id="rememberMe" className={loginPageStyles.checkbox} checked={rememberMe} onChange={()=>setRememberMe(!rememberMe)} required disabled={submitting} />
                  </div>
                  <div className={loginPageStyles.checkboxLabelContainer}>
                      <label htmlFor="rememberMe" className={loginPageStyles.checkboxLabel}>Remember Me{"  "}</label>
          ...
          <div className={loginPageStyles.signupContainer}>
                <span className={loginPageStyles.signupText}>
                  ...
                  <Link to="/signup" className={loginPageStyles.signupLink}>Sign up</Link>
          </div>
        </div>
      </div>
       <style>
